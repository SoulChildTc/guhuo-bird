...
from guhuo-bird.apps.utils import get_abs_dir
from guhuo-bird.apps.utils.constants import METHODTYPE

index = Blueprint('index', __name__, url_prefix='/guhuo-bird/',
